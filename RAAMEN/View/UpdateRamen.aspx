<%@ Page Title="" Language="C#" MasterPageFile="~/NavigationBar.Master" AutoEventWireup="true" CodeBehind="UpdateRamen.aspx.cs" Inherits="RAAMEN.View.UpdateRamen" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <asp:Label ID="RamenLbl" runat="server" Text="Ramen Id"></asp:Label><br />
        <asp:TextBox ID="RamenTxt" runat="server" AutoCompleteType="Disabled"></asp:TextBox><br />
        ...
        <asp:Button ID="UpdateBtn" runat="server" Text="Insert" onclick="UpdateBtn_Click" /><br />
